...
mongo --host z/gen2db:27101,gen2db:27102,gen2db:27103  mydb --eval "db.zips.count()"
mongo --port 27101  mydb --eval "db.zips.count()"
...
mongo mydb --port 27001 --eval "db.zips.ensureIndex({'_id':'hashed'})
sh.shardCollection('mydb.zips', {'_id':'hashed'})"
...
sleep 1
mongo mydb --port 27001 --eval "sh.status()"
